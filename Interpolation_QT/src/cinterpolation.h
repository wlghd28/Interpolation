...
public:
    ...
    double cal_cubic_spline(double x, std::vector<double>* poly_coeff);
    double cal_monotonic_cubic_Hermite_spline(double x, std::vector<double>* poly_coeff);
    double h00(double t);
    double h10(double t);
    double h01(double t);
    double h11(double t);
